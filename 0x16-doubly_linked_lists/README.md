...
4. 4-free_dlistint.c // a function that free a dlistint_t list.
...
7. 7-insert_dnodeint.c, 2-add_nodeint.c, 3-add_dnodeint_end.c // a function that inserts a new node at a given position.
